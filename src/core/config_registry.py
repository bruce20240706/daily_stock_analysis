...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MARKET_REVIEW_REGION": {
        ...
        "description": "Market region for review: cn (A-shares), hk (Hong Kong), us (US stocks), crypto (crypto assets), or both (cn+hk+us, excludes crypto).",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "cn",
        "options": ["cn", "hk", "us", "crypto", "both"],
        "validation": {"enum": ["cn", "hk", "us", "crypto", "both"]},
        "display_order": 47,
        "help_key": "settings.system.market_review",
        "examples": [
            "MARKET_REVIEW_REGION=cn",
    ...
    "SIGNAL_BACKTEST_ENABLED": {
        "title": "Signal Backtest Enabled",
        "description": "Whether to run forward backtest on volume-price signals (M3-A). Disabled by default; enable to attach per-signal backtest outcomes.",
        "category": "backtest",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 60,
        "help_key": "settings.backtest.SIGNAL_BACKTEST_ENABLED",
        "examples": [
            "SIGNAL_BACKTEST_ENABLED=false",
            "SIGNAL_BACKTEST_ENABLED=true",
        ],
        "docs": [
            {
                "label": "完整指南：回测配置",
    ...
    "SIGNAL_BACKTEST_HORIZON_BARS": {
        "title": "Signal Backtest Horizon Bars",
        "description": "Forward-looking window (in bars) for signal-level backtest. How many bars ahead to evaluate a signal's outcome.",
        "category": "backtest",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 70,
        "help_key": "settings.backtest.SIGNAL_BACKTEST_HORIZON_BARS",
        "examples": [
            "SIGNAL_BACKTEST_HORIZON_BARS=10",
            "SIGNAL_BACKTEST_HORIZON_BARS=20",
        ],
        "docs": [
            {
                "label": "完整指南：回测配置",
    ...
    "CRYPTO_INTRADAY_BACKTEST_INTERVAL": {
        ...
        "examples": ["CRYPTO_INTRADAY_BACKTEST_INTERVAL=5m"],
        "docs": [
            {
                "label": "完整指南：回测配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#回测功能",
    ...
    "CRYPTO_INTRADAY_MINUTE_CACHE_TTL_S": {
        ...
        "examples": ["CRYPTO_INTRADAY_MINUTE_CACHE_TTL_S=900"],
        "docs": [
            {
                "label": "完整指南：回测配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#回测功能",
    ...
    "CRYPTO_INTRADAY_BACKTEST_FEE_BPS": {
        ...
        "examples": ["CRYPTO_INTRADAY_BACKTEST_FEE_BPS=4"],
        "docs": [
            {
                "label": "完整指南：回测配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#回测功能",
    ...
    "CRYPTO_INTRADAY_BACKTEST_SLIPPAGE_BPS": {
        ...
        "examples": ["CRYPTO_INTRADAY_BACKTEST_SLIPPAGE_BPS=2"],
        "docs": [
            {
                "label": "完整指南：回测配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#回测功能",
    ...
    "INTRADAY_BACKTEST_ENABLED": {
        ...
        "examples": ["INTRADAY_BACKTEST_ENABLED=false"],
        "docs": [
            {
                "label": "完整指南：回测配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#回测功能",
    ...
    "INTRADAY_BACKTEST_SCHEDULE_MINUTES": {
        ...
        "examples": ["INTRADAY_BACKTEST_SCHEDULE_MINUTES=60"],
        "docs": [
            {
                "label": "完整指南：回测配置",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#回测功能",
    ...
    "CRYPTO_NEW_LISTING_ENABLED": {
        "title": "Crypto New Listing Discovery",
        "description": "Enable structured new-listing discovery for crypto assets. When enabled, the daily run scans configured exchanges for recently listed trading pairs.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 72,
        "help_key": "settings.data_source.crypto_new_listing",
        "examples": [
            "CRYPTO_NEW_LISTING_ENABLED=true",
            "CRYPTO_NEW_LISTING_ENABLED=false",
        ],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
    ...
    "CRYPTO_NEW_LISTING_WINDOW_DAYS": {
        "title": "Crypto New Listing Window (Days)",
        "description": "Look-back window in days for new-listing discovery. Pairs listed within this many days are considered newly listed.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "help_key": "settings.data_source.crypto_new_listing",
        "examples": [
            "CRYPTO_NEW_LISTING_WINDOW_DAYS=7",
            "CRYPTO_NEW_LISTING_WINDOW_DAYS=14",
        ],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
    ...
    "CRYPTO_NEW_LISTING_SOURCES": {
        "title": "Crypto New Listing Sources",
        "description": "Comma-separated list of exchanges to query for new-listing discovery (e.g. okx,coinbase,binance). Default excludes binance because binance discovery requires a persistent DB volume; CI ephemeral environments produce no binance output.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "okx,coinbase",
        "options": [],
        "validation": {},
        "display_order": 74,
        "help_key": "settings.data_source.crypto_new_listing",
        "examples": [
            "CRYPTO_NEW_LISTING_SOURCES=okx,coinbase",
    ...
    "CRYPTO_NEW_LISTING_MAX": {
        "title": "Crypto New Listing Max",
        "description": "Maximum number of new-listing results returned per discovery run.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "help_key": "settings.data_source.crypto_new_listing",
        "examples": [
            "CRYPTO_NEW_LISTING_MAX=20",
            "CRYPTO_NEW_LISTING_MAX=50",
        ],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
